...
public class BankOCRTest {
    ...
    public void should_get_correct_message_given_valid_and_legible_number() throws Exception {
        //Given
        String filePath = getClass().getClassLoader().getResource("ValidAndLegibleAccountNumber.txt").getPath();
    ...
    public void should_get_correct_message_given_invalid_and_legible_number() throws Exception {
        //Given
        String filePath = getClass().getClassLoader().getResource("InvalidAndLegibleAccountNumber.txt").getPath();
        BankOCR printer = new BankOCR();
    ...
    public void should_get_correct_message_given_illegible_number() throws Exception {
        //Given
        String filePath = getClass().getClassLoader().getResource("IllegibleAccountNumber.txt").getPath();
        BankOCR printer = new BankOCR();
